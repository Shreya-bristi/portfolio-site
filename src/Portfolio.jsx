...
const C = {
  ...
  skills: [
    ...
    { category: "AI & Deep Learning", icon: "brain", desc: "Deep learning, natural language processing, computer vision, and large language models.", items: ["TensorFlow", "PyTorch", "Keras", "OpenCV", "NLTK", "Scikit-learn", "LangChain", "RAG", "Hugging Face", "GroqCloud", "LLaMA API"] },
    { category: "Cloud & DevOps", icon: "cloud", desc: "Database management, CI/CD pipelines, workflow automation, and cloud infrastructure.", items: ["MySQL", "PostgreSQL", "Google BigQuery", "AWS", "Azure", "Airflow", "n8n", "Docker", "Databricks", "GitHub Actions", "Snowflake"] },
      ...
      <Reveal id="contact" from="right">
        <div style={{ maxWidth: 1320, margin: "0 auto", padding: "40px 24px 100px", textAlign: "center" }}>
          ...
          <p style={{ fontSize: 15, color: "var(--t2)", lineHeight: 1.7, marginBottom: 30 }}>
            I'm actively looking for Data Analyst, Business Intelligence, and Data Scientist roles.\nIf my profile looks like a fit, I'd love to hear from you.
          </p>
